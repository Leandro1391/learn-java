...
public class UsuarioDAO implements IUsuarioDao{
      ...
      public List<UsuarioDTO> seleccionar() throws SQLException{
            ...
            try {
                  ...
                  while (rs.next()) {
                        ...
                        unUsuario = new UsuarioDTO(idUsuario, usuario, password);
      ...
      public int insertar(UsuarioDTO unUsuario) throws SQLException {
            Connection conn = null;
            PreparedStatement stmt = null;
            int registros = 0;
      ...
      public int actualizar(UsuarioDTO unUsuario) throws SQLException {
            Connection conn = null;
            PreparedStatement stmt = null;
            int registros = 0;
            try {
      ...
      public int eliminar(UsuarioDTO unUsuario) throws SQLException {
            Connection conn = null;
            PreparedStatement stmt = null;
            int registros = 0;
            try {
